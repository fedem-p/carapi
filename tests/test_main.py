...
def test_main_basic_flow(mock_print, mock_config_class, mock_scraper_class, 
                        mock_exporter_class, mock_autoscore_class, mock_notifier_class):
    ...
    mock_ranked_cars = pd.DataFrame([{
        'make': 'BMW', 'model': '3 Series', 'price': 25000,
        'mileage': 50000, 'year': 2020, 'score': 22.5, 'grade': 'Good',
    ...
    actual_sorts = [call[1]['sort_method'] for call in mock_scraper.scrape_data.call_args_list]
...
@patch('src.main.Config')
@patch('builtins.print')
def test_main_with_email_flag(mock_print, mock_config_class, mock_scraper_class, 
                             mock_exporter_class, mock_autoscore_class, mock_notifier_class):
    ...
    mock_notifier.send_email.assert_called_once_with("Latest Car Listings", mock_ranked_cars)
...
@patch('src.main.Config')
@patch('builtins.print')
def test_main_with_email_env_var(mock_print, mock_config_class, mock_scraper_class, 
                                mock_exporter_class, mock_autoscore_class, mock_notifier_class):
...
@patch('src.main.Config')
@patch('builtins.print')
def test_main_export_filenames(mock_print, mock_config_class, mock_scraper_class, 
                              mock_exporter_class, mock_autoscore_class, mock_notifier_class):
    ...
    actual_filenames = [call[0][0] for call in mock_exporter.export_to_csv.call_args_list]
...
@patch('src.main.Config')
@patch('builtins.print')
def test_main_print_messages(mock_print, mock_config_class, mock_scraper_class, 
                           mock_exporter_class, mock_autoscore_class):
    ...
    mock_print.assert_any_call("================ Scraping with sorting: standard ================")
    mock_print.assert_any_call("================ Scraping with sorting: price ================")
    mock_print.assert_any_call("================ Scraping with sorting: age ================")
