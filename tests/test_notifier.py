...
@patch('smtplib.SMTP')
def test_send_email_success_with_dataframe(mock_smtp, mock_get_table_html, mock_config, sample_cars_df):
...
@patch('src.notifier.get_table_html')
@patch('smtplib.SMTP')
def test_send_email_success_with_list(mock_smtp, mock_get_table_html, mock_config, sample_cars_list):
...
@patch('smtplib.SMTP')
@patch('builtins.print')
def test_send_email_smtp_exception(mock_print, mock_smtp, mock_get_table_html, mock_config, sample_cars_df):
...
@patch('src.notifier.get_table_html')
@patch('smtplib.SMTP')
def test_send_email_message_content(mock_smtp, mock_get_table_html, mock_config, sample_cars_df):
...
@patch('smtplib.SMTP')
@patch('builtins.print')
def test_send_email_prints_status_messages(mock_print, mock_smtp, mock_get_table_html, mock_config, sample_cars_df):
