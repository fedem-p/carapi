    ...
    return {
        "makes": [
            ...
            },
            {
                "id": "2",
                "name": "Audi",
                "models": [{"id": "201", "name": "A4"}, {"id": "202", "name": "Q7"}],
            },
            {
                "id": "3",
                "name": "Tesla",  # This might be filtered out depending on FILTER_MAKES
                "models": [{"id": "301", "name": "Model S"}],
            },
            {"id": "4", "name": "NoModelsBrand"},  # Make without models key
        ]
    }
...
def test_save_makes_to_csv_no_models_key(sample_api_response):
    ...
    test_data = {
        "makes": [
            {"id": "1", "name": "BMW", "models": [{"id": "101", "name": "3 Series"}]},
            {"id": "4", "name": "BMW"},  # This one has no models key
        ]
    }
...
"""
    ...
    try:
        ...
        # Verify results
        assert makes_mapping == {"bmw": "1", "audi": "2"}  # Lowercase key
...
"""
    ...
    try:
        ...
        assert makes_mapping == {"bmw": "1", "audi": "3"}
    ...
    test_data = {
        "makes": [
            ...
            },  # lowercase
            {
                "id": "2",
                "name": "BMW",
                "models": [{"id": "102", "name": "X5"}],
            },  # uppercase
            {
                "id": "3",
                "name": "NotInFilter",
                "models": [{"id": "103", "name": "Test"}],
            },
        ]
    }
